 ...
 * Text Domain: font-stripper
 *
 * @package   Font_Stripper
 * @copyright Copyright (C) 2025 Danny Cooper
...
class Font_Stripper {
	...
	public function strip_font_declarations( $content ) {
		...
		$array = array( 'font-family', 'font-size', 'font-weight', 'line-height', 'color' );
		$array = [ 'font-family', 'font-size', 'font-weight', 'line-height', 'color' ];
