...
This can be useful if you have a lot of content with out of date styling. It also removes unwanted styles that may appear when copy and pasting from Microsoft Word.
